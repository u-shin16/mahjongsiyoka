...
var CH_INTROS = {
  ...
  ch10_9: {
    icon: '🀀',
    points: [
      '<strong>ダブル東</strong>＝場風・自風がどちらも東（親で東場）のときの東の刻子',
      '役牌が2つ分（2翻）になる特別なケース',
      'この問題では「場風：東、自風：東」で考えよう',
    ],
    example: '✅ 東の刻子（場風・自風とも東）\n❌ 南・西・北の刻子（場風でも自風でもない）',
    tip: '💡 3枚の刻子を見て「ダブル東になる？」を○✕で答えよう！',
  },
  ch10_10: {
    icon: '🎴',
    points: [
  ...
  ch10_11: {
    ...
    points: [
      ...
      'これまで学んだ10種類の役（一盃口・七対子・対々和・三色同順・三色同刻・一気通貫・三暗刻・混全帯幺九・小三元・ダブル東）から出題',
