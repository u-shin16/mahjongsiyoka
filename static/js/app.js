...
var CH_INTROS = {
  ...
  ch1_0: {
    icon: '🔁',
    points: [
      '配られるのは<strong>13枚</strong>。自分の番が来たら<strong>山から1枚ツモって14枚</strong>にする',
      '14枚から<strong>いらない牌を1枚捨てて13枚に戻す</strong>。これで自分の番が終わり、<strong>下家（右の人）</strong>へ回る',
      '山が無くなるまで誰もアガらなければ<strong>流局</strong>。次の局へ進む',
    ],
    example: '配牌13枚 → ツモって14枚 → 1枚捨てて13枚 → 次の人へ\n\nこれをずっとくり返して、先にアガリ形を作った人の勝ち',
