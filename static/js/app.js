...
var CH_INTROS = {
  ...
  ch8_3: {
    icon: '📛',
    points: [
      '初心者がよく使う役：<strong>立直・タンヤオ・平和・役牌・門前清自摸和</strong>',
      '立直＝門前テンパイで宣言／門前清自摸和＝門前でツモ和了',
      '説明文を読んで、ぴったり合う役の名前を選ぼう',
    ],
    example: '「2〜8だけで作る役」→ タンヤオ\n「門前テンパイで1000点宣言」→ 立直\n「門前でツモ和了」→ 門前清自摸和',
    tip: '💡 5つの役から正しいものを1つ選ぼう！',
  },
  // Chapter 9: 翻を数えてみよう
  ch9_0: {
    icon: '🧮',
  ...
  ch10_1: {
    icon: '🎴',
    points: [
      '中級でよく出る役は全部で10種類：<strong>一盃口・七対子・対々和・三色同順・三色同刻・一気通貫・三暗刻・混全帯幺九・小三元・ダブル東</strong>',
...
function showClear(chId, stars) {
  var msgs = {1:'はじめてのアガリ！麻雀は「セット」と「頭」を作るゲームだよ。',2:'色の違いを理解したね！',3:'本物の麻雀牌を使いこなせるようになってきた！',4:'字牌をすべて覚えたかな？',5:'役牌をマスターした！',6:'ポンとチーを使いこなせるようになった！',7:'道場チャレンジ完了！',8:'立直・タンヤオ・平和・門前清自摸和を覚えた！',9:'翻と点数が読めるようになった！',10:'中級役（七対子・対々和など）をマスター！',11:'清一色などの上級役まで到達！すごい！',12:'三人麻雀のルールもバッチリ！'};
