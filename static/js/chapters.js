  ...
  const ch8 = {
    mgs: [
      ...
      },
      {
        ...
        passNeeded: 3,
        questions: [
          { text: '門前（鳴きなし）でテンパイし、1000点を出して宣言する役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和'], answer: '立直', fb: '門前でテンパイしたら立直（リーチ）！1000点を供託して宣言するよ。' },
          { text: '2〜8の数牌だけ（1・9・字牌なし）で作る役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和'], answer: 'タンヤオ', fb: '断么九（タンヤオ）！中張牌だけで作るよ。' },
          { text: '全部順子・頭が役牌以外・両面待ち、の3条件で成立する役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和'], answer: '平和', fb: 'ピンフ（平和）！3つの条件すべてが必要だよ。' },
          { text: '白・發・中などの同じ牌3枚（刻子）で成立する役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和'], answer: '役牌', fb: '役牌（ヤクハイ）！三元牌や場風・自風の刻子で成立。' },
          { text: '鳴かずにツモで和了したときだけ成立する役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和'], answer: '門前清自摸和', fb: '門前清自摸和（メンゼンツモ）！門前でツモ和了したときだけの1翻役。' },
        ],
      },
    ],
  };
