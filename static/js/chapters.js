    ...
    mgs: [
      {
        ...
        passNeeded: 4,
        questions: [
          { text: '対局が始まったとき、最初に配られる牌は何枚？', choices: ['13枚','14枚','12枚','16枚'], answer: '13枚', fb: '配牌は13枚。ここから1枚ツモって1枚捨てる、をくり返すよ。' },
          { text: '自分の番が来たとき、最初にすることは？', choices: ['山から1枚ツモる','いらない牌を1枚捨てる','鳴く','立直を宣言する'], answer: '山から1枚ツモる', fb: 'まず山から1枚ツモる。これで手牌が14枚になるよ。' },
          { text: 'ツモった直後、自分の手牌は何枚？', choices: ['14枚','13枚','15枚','12枚'], answer: '14枚', fb: '13枚＋ツモ牌1枚で14枚。この14枚から1枚選んで捨てるよ。' },
          { text: '自分の番の最後にすることは？', choices: ['いらない牌を1枚捨てる','山から1枚ツモる','点数を数える','牌を並べ替える'], answer: 'いらない牌を1枚捨てる', fb: '1枚捨てて13枚に戻す。これで自分の番が終わり、次の人へ回るよ。' },
          { text: '自分の次に打つのは誰？', choices: ['下家（右の人）','上家（左の人）','対面（向かいの人）','決まっていない'], answer: '下家（右の人）', fb: '順番は下家（右の人）へ回る。だからチーは上家（左の人）からしかできないんだよ。' },
          { text: '山の牌が無くなるまで誰もアガらなかったら？', choices: ['流局になって次の局へ進む','その場で全員が負けになる','もう一度配りなおす','親が勝ちになる'], answer: '流局になって次の局へ進む', fb: '流局（リュウキョク）。テンパイしていた人としていない人で点数のやりとりをして、次の局へ進むよ。' },
        ],
      },
      {
        type: 'choice',
        title: 'ミニゲーム②　ロンとツモ、どっち？',
        instruction: 'アガり方は<strong>ロン</strong>と<strong>ツモ</strong>の2つ。どちらの話か選ぼう！',
        passNeeded: 4,
        questions: [
