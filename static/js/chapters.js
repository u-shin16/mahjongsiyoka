...
const Chapters = (() => {
    ...
    mgs: [
      {
        type: 'choice',
        title: 'ミニゲーム①　対局の進め方',
        instruction: '一局がどう進むかを覚えよう！',
        passNeeded: 4,
        questions: [
          { text: '対局が始まったとき、最初に配られる牌は何枚？', choices: ['13枚','14枚','12枚','16枚'], answer: '13枚', fb: '最初に配られるのは13枚。ここから1枚とって1枚捨てる、をくり返すよ。' },
          { text: '自分の番が来たとき、最初にすることは？', choices: ['積んである牌から1枚とる','いらない牌を1枚捨てる','人の牌をもらう','点数を数える'], answer: '積んである牌から1枚とる', fb: 'まず1枚とる（これをツモという）。手牌が14枚になるよ。' },
          { text: '1枚とった直後、自分の手牌は何枚？', choices: ['14枚','13枚','15枚','12枚'], answer: '14枚', fb: '13枚＋とった1枚で14枚。この14枚から1枚選んで捨てるよ。' },
          { text: '自分の番の最後にすることは？', choices: ['いらない牌を1枚捨てる','もう1枚とる','点数を数える','牌を並べ替える'], answer: 'いらない牌を1枚捨てる', fb: '1枚捨てて13枚に戻す。これで自分の番が終わり、次の人へ回るよ。' },
          { text: '自分の次に打つのは誰？', choices: ['下家（右の人）','上家（左の人）','対面（向かいの人）','決まっていない'], answer: '下家（右の人）', fb: '順番は下家（右の人）へ回る。だからチーは上家（左の人）からしかできないんだよ。' },
          { text: '積んである牌が無くなるまで誰もアガらなかったら？', choices: ['流局になって次の局へ進む','その場で全員が負けになる','もう一度配りなおす','親が勝ちになる'], answer: '流局になって次の局へ進む', fb: '流局（リュウキョク）。テンパイしていた人としていない人で点数のやりとりをして、次の局へ進むよ。' },
        ],
      },
      {
        type: 'choice',
        title: 'ミニゲーム②　ロンとツモ、どっち？',
        instruction: 'アガり方は2つ。<strong>ロン</strong>＝他の人が捨てた牌でアガる／<strong>ツモ</strong>＝自分でとった牌でアガる。どちらの話か選ぼう！',
        passNeeded: 4,
        questions: [
          { text: '他の人が捨てた牌でアガった。', choices: ['ロン','ツモ'], answer: 'ロン', fb: '他の人の捨て牌でアガるのがロン。' },
          ...
          { text: '人に鳴かせていなければ、それだけで役が1つ付くのはどっち？', choices: ['ロン','ツモ'], answer: 'ツモ', fb: '鳴かずにツモでアガると、それだけで役が1つ付く。ツモは役に困りにくいよ。' },
  ...
  const ch8 = {
    mgs: [
      ...
      // 2026-09-07：フリテンと「役が無いとアガれない」は、テンパイと役を
      // 知らないと意味が分からない。第1章に置いていたが早すぎたので、
      // 役をひととおり覚えたこの章の最後へ移した。
      {
        type: 'yn',
        ...
        passNeeded: 6,
        questions: [
          { text: '門前でテンパイし、立直を宣言してからロン和了した。', answer: true, fb: '立直そのものが役！宣言していればアガれる。' },
          { text: '鳴かずにツモ和了した。ほかに役は無い。', answer: true, fb: '門前でツモなら門前清自摸和が付く。だからツモは役無しになりにくい。' },
          { text: '中を3枚ポンして、その形のまま和了した。', answer: true, fb: '役牌（中）の刻子が役になる。鳴いてもアガれるよ。' },
          { text: 'ポンをして、2〜8の数牌だけで和了した。', answer: true, fb: 'タンヤオは鳴いても成立する数少ない役。だから鳴くならまず狙う形。' },
          { text: 'チーをして順子だけの手にしたが、役牌もタンヤオも無かった。', answer: false, fb: '形はそろっていても役が無いのでアガれない。対局画面ではこれが「役なし」と出るよ。' },
          { text: 'ドラが3枚あるが、役が1つも無い状態でロン和了した。', answer: false, fb: '<strong>ドラは役ではない</strong>。何枚あっても役の代わりにはならない。ここが一番まちがえやすいところ。' },
          { text: '門前でテンパイしたが立直を宣言せず、そのままロン和了した。手には役が1つも無い。', answer: false, fb: '立直を宣言していないと役が無い。門前でも、ロンなら役が要る。' },
          { text: 'ポンをして1・9や字牌が混じった手を作り、役が1つも無い状態でロン和了した。', answer: false, fb: '鳴くとタンヤオも門前の役も消える。鳴くときは何が役になるかを先に決めよう。' },
        ],
      },
      {
        type: 'yn',
        ...
        passNeeded: 6,
        questions: [
          { text: '待ちは3筒と6筒。自分の河にはどちらも捨てていない。他家が3筒を捨てた。', answer: true, fb: '待ちの牌をひとつも捨てていないのでロンできる。' },
          { text: '待ちは3筒と6筒。自分の河に6筒を捨てている。他家が3筒を捨てた。', answer: false, fb: '<strong>待ちの片方でも捨てているとフリテン。</strong>もう一方の牌でもロンできない。ここが一番まちがえやすいところ。' },
          { text: '待ちは5萬だけ。自分の河に5萬を捨てている。他家が5萬を捨てた。', answer: false, fb: '自分で捨てた牌ではロンできない。これがフリテンの基本の形。' },
          { text: 'フリテンの状態で、自分でアガリ牌をツモった。', answer: true, fb: '<strong>フリテンでもツモならアガれる。</strong>だから画面には「ツモのみ」と出るよ。' },
          { text: '待ちは2索と5索。ずっと前の巡目に自分が5索を捨てていた。他家が2索を捨てた。', answer: false, fb: '何巡前でも関係ない。その局のあいだフリテンは続く。' },
