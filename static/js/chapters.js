  ...
  const ch8 = {
    mgs: [
      ...
      },
      {
        type: 'yn',
        title: 'ミニゲーム④　一発になる？',
        instruction: 'つぎの状況は<strong>一発</strong>（イッパツ）になる？（立直宣言後、1週以内・鳴きなしで和了すると成立）',
        yesLabel: '○ 成立する', noLabel: '✕ 成立しない',
        passNeeded: 6,
        questions: [
          { text: '立直を宣言した直後の1週目で、誰も鳴かずにツモ和了した。', answer: true, fb: '立直後1週以内・鳴きなしでツモ！一発成立、1翻。' },
          { text: '立直を宣言した直後の1週目で、誰も鳴かずにロン和了した。', answer: true, fb: '一発はツモでもロンでもOK！鳴きが入らなければ成立するよ。' },
          { text: '立直を宣言した後、他家がポンをしてから和了した。', answer: false, fb: '誰かが鳴く（ポン・チー・カン）と、その時点で一発は消える。' },
          { text: '立直を宣言してから2週目以降に和了した。', answer: false, fb: '1週以内でないと一発は成立しない！2週目以降はアウト。' },
          { text: '立直を宣言した直後の1週目で、他家がチーをしてから自分がロン和了した。', answer: false, fb: 'チーも「鳴き」！間に鳴きが入ると一発は消える。' },
          { text: '立直を宣言した直後の1週目で、誰も鳴かずにツモ和了した（ダブルリーチだった）。', answer: true, fb: 'ダブルリーチと一発は同時に成立できる！鳴きなし・1週以内が条件。' },
          { text: '立直を宣言した後、自分が暗カンをしてからツモ和了した。', answer: false, fb: '自分の暗カンも「鳴き」に数えるので一発は消える。' },
          { text: '立直を宣言した直後の1週目で、誰も鳴かずに他家の捨て牌でロン和了した。', answer: true, fb: '鳴きが一切なければ、他家の捨て牌でのロンでも一発成立！' },
        ],
      },
      {
        type: 'yn',
      ...
      },
      {
        ...
        questions: [
          ...
          { text: '全部順子・頭が役牌以外・両面待ち、の3条件で成立する役は？', choices: ['立直','タンヤオ','平和','役牌','門前清自摸和','一発'], answer: '平和', fb: 'ピンフ（平和）！3つの条件すべてが必要だよ。' },
          ...
          { text: '立直宣言後、1週以内・鳴きなしで和了すると成立する役は？', choices: ['立直','門前清自摸和','一発','役牌'], answer: '一発', fb: '一発（イッパツ）！立直とセットでよく出る1翻役。' },
        ],
      },
    ],
  };
    ...
    mgs: [
      ...
      },
      {
        ...
        questions: [
          ...
          { tiles: [{suit:'man',num:9},{suit:'man',num:9},{suit:'man',num:9},{suit:'pin',num:1},{suit:'pin',num:2},{suit:'pin',num:3},{suit:'sou',num:7},{suit:'sou',num:8},{suit:'sou',num:9},{suit:'man',num:1},{suit:'man',num:2},{suit:'man',num:3},{suit:'pin',num:7},{suit:'pin',num:7}], answer: true, fb: '全部の面子・頭に1か9！純全帯幺九だよ。' },
      ...
      },
      {
        ...
        passNeeded: 4,
        questions: [
          { tiles: [{suit:'man',num:1},{suit:'man',num:2},{suit:'man',num:3},{suit:'man',num:4},{suit:'man',num:5},{suit:'man',num:6},{suit:'man',num:7},{suit:'man',num:8},{suit:'man',num:9},{suit:'man',num:3},{suit:'man',num:4},{suit:'man',num:5},{suit:'man',num:7},{suit:'man',num:7}], choices: ['清一色','混一色','一気通貫','純全帯幺九'], answer: '清一色', fb: '萬子だけで全部そろっている（字牌なし）！清一色。' },
