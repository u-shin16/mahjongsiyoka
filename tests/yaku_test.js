...
// ---- 七対子は7種類の異なる対子が要る（2026-09-02に見つけて直した） ----
// 同じ牌4枚を2組の対子として数えて七対子にしていた。
// 第10章のクイズでは「それはダメ」と正しく教えていたのに、対局では成立していた。
(function() {
  var h4 = [m(5),m(5),m(5),m(5), p(2),p(2), p(7),p(7), s(3),s(3), s(9),s(9), w(1),w(1)];
  check('同じ牌4枚を含む形は七対子にならない', h4,
    { winTile: last(h4), notExpect: ['七対子'] }, []);

  var h5 = [m(3),m(3), m(8),m(8), p(6),p(6), p(9),p(9), s(4),s(4),s(4),s(4), d(1),d(1)];
  check('4索4枚の形も七対子にならない', h5,
    { winTile: last(h5), notExpect: ['七対子'] }, []);

  // 7種類そろっていれば今までどおり成立する
  var h6 = [m(1),m(1), m(5),m(5), p(2),p(2), p(8),p(8), s(3),s(3), s(9),s(9), d(2),d(2)];
